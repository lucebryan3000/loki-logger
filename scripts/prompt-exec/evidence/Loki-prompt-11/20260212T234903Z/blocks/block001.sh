...
umask 022
source "/home/luce/apps/loki-logging/scripts/prompt-exec/evidence/Loki-prompt-11/20260212T234903Z/env.sh"
...
RUNTIME_MAXFILE="$(python3 - "${PRISM_EVID_DIR}/codeswarm_container_inspect.json" <<'PY'
import json, sys
p = sys.argv[1]
d = json.load(open(p))
