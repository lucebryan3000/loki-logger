...
codex_exec_last_run_local: 4:18 PM - 13-02-2026
codex_exec_last_run_warning_count: '0'
codex_exec_last_run_last_ok_block: '1'
codex_exec_last_run_move_status: skipped
codex_exec_last_run_dir: /home/luce/apps/loki-logging/temp/codex-sprint/runs.jsonl#prompt-02-mini--r0005
prompt_flow:
  version: v1
  stages:
    draft:
      source: chatgpt
      status: drafted
      updated_utc: '2026-02-13T22:18:13Z'
      scoping:
        kind: task
        scope: single-file
    ...
    exec:
      source: prompt-exec
      status: success
      run_local: 4:18 PM - 13-02-2026
      run_ref: /home/luce/apps/loki-logging/temp/codex-sprint/runs.jsonl#prompt-02-mini--r0005
      prompt_sha: c88063c643fc536b33a5944fe7c2a7318f1b259e5ad8abc2f1ea036f4eba2995
      completion_gate: pass
      last_ok_block: '1'
      warning_count: '0'
      move_status: skipped
      updated_utc: '2026-02-13T22:18:15Z'
      next_stage: pipeline
    pipeline:
      ...
      policy:
        ...
        loop_threshold: '3'
        profile: production
      updated_utc: '2026-02-13T22:19:08Z'
codex_verify_files_exist: *id001
codex_exec_last_run_prompt_sha: c88063c643fc536b33a5944fe7c2a7318f1b259e5ad8abc2f1ea036f4eba2995
