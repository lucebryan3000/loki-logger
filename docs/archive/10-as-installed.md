...
Tooling:
- Docker: `29.2.1`
- Compose: `Docker Compose version v5.0.2`
...
infra_observability-alloy-1           grafana/alloy:v1.2.1               "/bin/alloy run --se…"   alloy           2 hours ago    Up 2 hours              
...
infra_observability-prometheus-1      prom/prometheus:v2.52.0            "/bin/prometheus --c…"   prometheus      2 hours ago    Up 2 hours              127.0.0.1:9004->9090/tcp
```

docker ps:
```
infra_observability-alloy-1	grafana/alloy:v1.2.1	Up 2 hours
infra_observability-prometheus-1	prom/prometheus:v2.52.0	Up 2 hours
codeswarm-mcp	codeswarm-mcp	Up 5 hours (healthy)
